 ...
 *
 */
public class VibrationNotifier implements Notifier {
	 ...
	 * 
	 */
	public VibrationNotifier() {
		super();
		try {
			this._image=Image.createImage(this.getClass().getResourceAsStream("/resources/vibration.jpeg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void notifyActivity(Activity act, Rule rule, Notification notification) {
		...
		/*Form form=new Form("SilentNotifier");
        StringItem disclaimer=new StringItem("Notification",msg);
